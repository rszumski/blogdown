...
This was done in R using [ggplot2](https://github.com/tidyverse/ggplot2), for the plotting, and the [ggiraph](https://github.com/davidgohel/ggiraph) package to make it interactive. 
