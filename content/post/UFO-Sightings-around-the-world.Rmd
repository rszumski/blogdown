...
I've been watching the 11th season of The X-Files and it got me thinking about UFOs. In my search for data on UFO sightings I came across a dataset on Kaggle that has 80,000+ documented close encounters from the past 70 years. Then I came across a R package called [dygraphs](https://rstudio.github.io/dygraphs/), for charting time-series data in R, and the [three.js](https://github.com/bwlewis/rthreejs) package, that has globejs: a somewhat silly widget that plots data and images on a 3-d globe. So lets put this all together. 
...
First a little data preparation, then lets count the occurrences for each country
...
Next lets make that somewhat silly 3-d globe widget.

Again a little data preparation, then lets count the occurrences for groups of latitude and longitude.
