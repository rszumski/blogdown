...
A friend was looking for data dealing with movie budget and performance, so I thought it would be a good opportunity to practice web scrapping from [The Numbers](https://www.the-numbers.com) using the [rvest](https://github.com/hadley/rvest) package. 

The goal is to obtain the release date,	movie, production budget,	domestic gross, and	worldwide gross from there [Budget and Financial](https://www.the-numbers.com/movie/budgets/) page. Then join that with the distributor, genre, and movie rating from the [MPAA Ratings](https://www.the-numbers.com/market/mpaa-ratings) page.
